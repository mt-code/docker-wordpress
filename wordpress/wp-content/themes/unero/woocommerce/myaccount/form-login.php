	...
	<div class="row">
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
							...
							<p class="form-row">
								...
								<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'unero' ); ?>"><?php esc_html_e( 'Log in', 'unero' ); ?></button>
							</p>
						...
						<div class="tabs-panel">
							...
							<form method="post" class="woocommerce-form woocommerce-form-register register">
								...
								<p class="woocomerce-FormRow form-row">
									...
									<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register', 'unero' ); ?>"><?php esc_html_e( 'Register', 'unero' ); ?></button>
								</p>
